...
# Database Paths
export DATABASE_PATH="postgresql://localhost/wineport_dev_db"
echo "DATABASE_PATH: "$DATABASE_PATH
export TEST_DATABASE_PATH="postgresql://localhost/wineport_test_db"
echo "TEST_DATABASE_PATH: "$TEST_DATABASE_PATH
